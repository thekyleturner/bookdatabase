...
namespace WindowsFormsApplication1
{
    public partial class Form2 : Form
    {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            {
                String stm = $"SELECT checkout.userID, student.studentFirstName, student.studentLastName, book.bookID, book.bookTitle FROM checkout, book, student WHERE checkout.userID = {UID} AND student.userID = checkout.userID AND checkout.bookID = book.bookID;";
                globalAdp = show(stm, conn);
            }
